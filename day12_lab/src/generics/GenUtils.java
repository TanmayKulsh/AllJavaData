...
//		basket.add(new Object());
	...
	//Write a method to addd a mango to thr fruit basket 
	public static void addMango(List<? super Mango> list,Mango m) {
		//with above method declaration which of the following is legal
...
//		list.add(new Orange());
	...
	// to get the maximum valie out of any type collection
...
//			if(itr.hasNext())
//				if(itr.hasPrevious())
					if((itr.previous().compareTo(itr.next()))!=1) {
						num=(T)itr.next();
